...
// mapInvitationError translates invitation-related sentinel errors into typed
// API errors; anything else is reported as an internal error.
func mapInvitationError(err error, operation string) error {
	switch {
...
func (h InvitationHandler) CreateInvitation(w http.ResponseWriter, r *http.Request) error {
	...
	if err != nil {
		return mapInvitationError(err, "création de l'invitation")
	}
...
func (h InvitationHandler) GetInvitation(w http.ResponseWriter, r *http.Request) error {
	...
	if err != nil {
		return mapInvitationError(err, "récupération de l'invitation")
	}
...
func (h InvitationHandler) AcceptInvitation(w http.ResponseWriter, r *http.Request) error {
	...
	if err != nil {
		return mapInvitationError(err, "acceptation de l'invitation")
	}
