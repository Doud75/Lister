...
describe('generateSetlistPdf', () => {
    const mockSetlist: SetlistDetails = {
        id: 1, name: 'My Awesome Setlist!', color: '#ff0000', created_at: '2024-01-01T12:00:00Z',
        items: [
            { id: 10, item_type: 'song', title: { String: 'First Song', Valid: true }, notes: { String: 'A little note', Valid: true } },
            { id: 11, item_type: 'interlude', title: { String: 'A quick talk', Valid: true }, speaker: { String: 'Lead', Valid: true }, script: { String: 'Hello world', Valid: true } },
            { id: 12, item_type: 'song', title: { String: 'Second Song', Valid: true }, notes: { String: '', Valid: false } },
        ]
    } as SetlistDetails;
    ...
    it('should generate the PDF with the correct filename and content', () => {
        ...
        expect(capturedTexts).toContain('Hello world');
