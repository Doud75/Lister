...
test.describe('Signup Page', () => {
    ...
    test('should validate password Requirements', async ({ page }) => {
        await page.getByLabel("Nom d'utilisateur").fill('ValidUser');
